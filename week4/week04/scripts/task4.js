...
let myInfo = {
    name: 'Hyrum Paramore',
    photo: 'images/resized_image.jpg',
    favoriteFoods: ['Sushi', 'Steak', 'Tacos'],
    hobbies: ['Camping', 'Snowboarding', 'Family', 'Gaming', 'Sports']
...
myInfo.placesLived.forEach((placesLived) => {
    ...
    placesLivedPlace.textContent = placesLived.places;
